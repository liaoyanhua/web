      ...
      <TABLE cellSpacing=0 cellPadding=0 width=300 border=0>
        <TR>
          <TD vAlign=bottom align=middle height=18>
             <SPAN class=STYLE5 style="font-size: 20px;">基于web的品优购管理系统</SPAN>
          </TD>
        </TR>
      </TABLE>
    </TD>
               ...
               <td width="260" valign="top">
                  ...
                  <table align="left" border="0" cellpadding="1" cellspacing="1">
						<tr align='center'>
							...
							<td align="left">
								<input name="userName" type="text"  value='a' style="width: 150px;"/>
							</td>
						</tr>
						<tr align='center'>
							<td style="width: 50px;" align="right">
							...
							<td align="left">
								<input name="userPw" type="password" value='a' style="width: 150px;"/>
							</td>
						</tr>
